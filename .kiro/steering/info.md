...
- Внутренние рассуждения и пометки пиши на английском (экономия токенов)
- Будь краток, точен, самостоятелен, но прислушивайся к пользователю
- Минимизируй комментарии действий, которые не требуют внимания пользователя
...
- Экономь токены - не перечитывай одни и те же места многократно
...
- **Принцип имени** - зона ответственности = имя компонента
...
│   ├── canvas_service.gd   # Управление холстом, CANVAS_SIZE константа
│   └── color_service.gd    # Управление цветами, swap colors (X key)
│
